...
public class DashboardController {
    ...
    @Operation(summary = "Executive dashboard", description = "Cross-workspace overview composed from analytics engine outputs.")
    public ApiResponse<ExecutiveDashboardResponse> executive() {
        return ApiResponse.of(executiveDashboardService.getExecutiveDashboard());
    }
