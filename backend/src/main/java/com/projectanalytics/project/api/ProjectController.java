...
public class ProjectController {
    ...
    public ProjectController(AnalyticsQueryService analyticsQueryService) {
        this.analyticsQueryService = analyticsQueryService;
    }

    @GetMapping("/{id}/dashboard")
    @Operation(summary = "Project dashboard", description = "Uses the shared analytics engine DTOs.")
    public ApiResponse<ProjectDashboardResponse> dashboard(@PathVariable UUID id) {
    ...
    public ApiResponse<ProjectWorkPackageAnalyticsResponse> workPackageAnalytics(@PathVariable UUID id) {
